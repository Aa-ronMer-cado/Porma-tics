namespace Pormatics.FuctionalityForm.OutfitGenerationForm
{
    partial class ConfirmGenerated
    {
        ...
        private void InitializeComponent()
        {
            ...
            SetupActionPicture(btnGenerateAgain, Properties.Resources.Reupload);
            btnGenerateAgain.Click += btnGenerateAgain_Click;

            SetupActionPicture(btnFavorite, Properties.Resources.faver);
            btnFavorite.Click += btnFavorite_Click;

            SetupActionPicture(btnBack, Properties.Resources.Restart);
        ...
        private void SetupActionPicture(PictureBox pictureBox, Image image)
        {
            ...
            pictureBox.Margin = new Padding(20, 10, 20, 10);
            pictureBox.SizeMode = PictureBoxSizeMode.Zoom;
